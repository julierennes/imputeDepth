################################################################################
## File:             exp.impute.glass.R                                       ##
## Created by:       Pavlo Mozharovskyi                                       ##
## Last revised:     23.12.2016                                               ##
##                                                                            ##
## Contains experiments on single depth-based imputation for the Glass data   ##
## set (Figure 6).                                                            ##
##                                                                            ##
################################################################################
...
for (i in 1:k){
  ...
  if (i %% 100 < 1){
    save.image(paste("glass_nf1-3_k", i, "_",
...
errors <- list(TukeyR2 = ems.depth.Tr2, zonoidM = ems.depth.zm,
               ...
               mean = ems.mean)
boxplot(errors, main = paste("Glass1-3, n = ", n, ", d = ", d, ", MCAR ", pNA, ", k = ", i, sep = ""),
        names = c("Tur2", "zom",
                  "Mah", "MahR",
                  "em", "for", "knn", "pc1", "pc2",
                  "mean"),
